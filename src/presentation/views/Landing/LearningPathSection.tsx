...
export default function LearningPathSection() {
  return (
    <section className="max-w-7xl mx-auto px-6 py-20 text-center relative">
      <h2 className="font-['suez-one'] text-5xl font-bold text-white mb-10">
        Explora nuestra ruta de aprendizaje
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Ciberseguridad */}
        <div className="relative group">
          <div className="bg-black/10 rounded-lg p-6 text-white shadow-lg border border-[rgba(168,85,247,0.3)] cursor-pointer">
            ...
            <h3 className="font-['Suez One'] text-xl font-semibold mb-2">Ciberseguridad</h3>
            <p className="font-['Orbitron'] text-gray-300">
              Aprende técnicas de ciberseguridad con laboratorios realistas
            </p>
          </div>
          {/* Tarjeta emergente */}
          <div className="absolute top-0 left-0 w-full bg-[#241A49] rounded-lg p-6 text-white shadow-lg border border-[rgba(168,85,247,0.3)] opacity-0 group-hover:opacity-100 group-hover:-translate-y-full transition-all duration-300 z-50">
            <h4 className="font-['Suez One'] text-lg font-bold mb-2">Más información</h4>
        ...
        <div className="relative group">
          <div className="bg-black/10 rounded-lg p-6 text-white shadow-lg border border-[rgba(168,85,247,0.3)] cursor-pointer">
            ...
            <h3 className="font-['Suez One'] text-xl font-semibold mb-2">Retos CTF</h3>
            <p className="font-['Orbitron'] text-gray-300">
        ...
        <div className="relative group">
          <div className="bg-black/10 rounded-lg p-6 text-white shadow-lg border border-[rgba(168,85,247,0.3)] cursor-pointer">
            ...
            <h3 className="font-['Suez One'] text-xl font-semibold mb-2">Cursos Guiados</h3>
            <p className="font-['Orbitron'] text-gray-300">
        ...
        <div className="relative group">
          <div className="bg-black/10 rounded-lg p-6 text-white shadow-lg border border-[rgba(168,85,247,0.3)] cursor-pointer">
            ...
            <h3 className="font-['Suez One'] text-xl font-semibold mb-2">Programación</h3>
