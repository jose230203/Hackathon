...
import { useCart } from "@/app/context/CartContext"; // ajusta si tu estructura es distinta
...
const BeverageCatalog = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/v1/products/paginated?product_type=coffee&limit=10&offset=0")
    ...
    <div className={styles.background}>
      <div className={styles.catalogContainer}>
        ...
        <div className={styles.tabs}>
          <span className={styles.activeTab}>Bebidas</span>
          <Link href="/catalogo/reposteria">Repostería</Link>
        </div>
